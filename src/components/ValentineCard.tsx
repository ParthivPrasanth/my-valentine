...
const ValentineCard = ({
  ...
  return <div className="flex flex-col items-center justify-center text-center px-6 max-w-md mx-auto">
      ...
      animationDelay: "0.3s"
    }}>I know you have been asking me this for a long time. I am sorry for not doing this sooner and I wanted to do something special instead of just simply asking 
      <br />
      ...
      animationDelay: "0.5s"
        ...
        <button onClick={handleAnswer} className="px-8 py-4 text-lg font-body font-semibold rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
          YES ❤️
        </button>
        <button onClick={handleAnswer} className="px-8 py-4 text-lg font-body font-medium rounded-full bg-secondary text-secondary-foreground border border-border hover:bg-muted transition-all duration-300 hover:scale-105 active:scale-95">
          no
        </button>
      </div>
    </div>;
